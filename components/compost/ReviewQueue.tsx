            ...
            >
              ...
              {it.snippet && (
                <p className="text-sm text-text-1 italic font-[family-name:var(--font-display)] leading-snug">
                  &ldquo;{it.snippet.slice(0, 200)}{it.snippet.length > 200 ? "…" : ""}&rdquo;
                </p>
              )}
              <div className="text-xs text-text-2">
                Said: <span className="text-text-0">&ldquo;{it.mention.raw_alias}&rdquo;</span>
              </div>
              <div className="flex flex-wrap gap-2 pt-1">
                ...
                <Link
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    // No-op for now — a future enhancement: create-new modal
                    // with the raw_alias pre-filled.
                  }}
                  className="px-3 py-1.5 rounded-sm border border-ink-4 text-text-1 hover:text-text-0 text-xs font-[family-name:var(--font-mono)]"
                >
                  + Create new
                </Link>
              </div>
          ...
          >
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[11px] text-text-2 mt-0.5">
                Auto-created — {it.mention_count} mention{it.mention_count === 1 ? "" : "s"} so far
              </div>
            </div>
            <Link
