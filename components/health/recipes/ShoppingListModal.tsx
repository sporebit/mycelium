      ...
      <div className="bg-ink-0 border border-hairline rounded-2xl w-full max-w-md max-h-[80vh] overflow-y-auto p-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex-1 py-2 rounded-v2-md bg-[#5de8e0]/15 border border-[#5de8e0]/40 text-[#5de8e0] text-[10px] font-[family-name:var(--font-mono)] tracking-[0.18em] hover:bg-[#5de8e0]/25 disabled:opacity-40 transition-colors"
          >
            {telegramSent ? "✓ SENT TO TELEGRAM" : sendingTelegram ? "SENDING…" : "SEND TO TELEGRAM"}
          </button>
          <button
            onClick={onClose}
            className="px-3 py-2 rounded-v2-md border border-hairline text-ink-3 hover:text-ink-4 text-[10px] font-[family-name:var(--font-mono)] tracking-[0.18em] transition-colors"
          >
            CLOSE
          </button>
        </div>
