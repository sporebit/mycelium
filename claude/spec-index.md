...
| `claude/people-contacts-spec.md` | **People contacts** (built 2026-09-25, 0140, MYC-165) — contact tier, vCard import with a review list (no automatic merges), numbers/emails tables, merge that walks every FK, soft delete + bin, `.vcf` export for iPhone / iCloud |
| `claude/tasks-merge-spec.md` | **Tasks + Tickets merge** (built 2026-09-25, 0139, MYC-163) — one Tasks surface, the Area chip, the dates table, `started_at` |
