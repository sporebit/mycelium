...
*Crawled 2026-08-29. The daily driver — highest-traffic surface; component dirs still named `compost/`. (?) = inferred. Quotes section added 2026-09-14; built 2026-09-19 (0126). Day-log touchpoints on People and Captures added 2026-09-14 (planned, not built — spec `claude/daylog-spec.md`).*
...
## Quotes (`/organisation/quotes`) — BUILT 2026-09-19 (0126, `3d46943`)
