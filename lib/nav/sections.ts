...
export const SECTIONS: SectionConfig[] = [
  {
    ...
    subPages: [
      ...
      { label: "Receipts", href: "/organisation/receipts", primary: false },
  ...
  },
  {
    ...
    subPages: [
      ...
      { label: "Calendar", href: "/fitness/calendar", primary: false },
      { label: "Phases", href: "/fitness/phases", primary: false },
    ],
  },
  {
    key: "health",
    ...
    subPages: [
      ...
      { label: "Gut health", href: "/health/gut-health", primary: false },
      { label: "Blood tests", href: "/health/blood-tests", primary: false },
      { label: "Recipes", href: "/health/recipes", primary: false },
      { label: "Shopping lists", href: "/health/shopping-lists", primary: false },
      { label: "Vision", href: "/health/eye-prescription", primary: false },
      { label: "Pain", href: "/health/pain", primary: false },
    ],
  },
  {
    key: "finance",
    ...
    baseRoute: "/finance",
    subPages: [
      { label: "Spending", href: "/finance/spending", primary: true },
      { label: "Analysis", href: "/finance/analysis", primary: true },
      { label: "Investments", href: "/finance/investments", primary: true },
      { label: "Accounts", href: "/finance/accounts", primary: false },
      { label: "Snapshot", href: "/finance/snapshot", primary: false },
      { label: "Advisor", href: "/finance/advisor", primary: false },
    ],
  },
  {
    key: "studio",
    ...
    baseRoute: "/studio",
    subPages: [
      { label: "Overview", href: "/studio", primary: true },
      { label: "Spotify", href: "/studio/spotify", primary: true },
      { label: "PC build", href: "/studio/pc", primary: false },
    ],
  },
  {
    key: "ventures",
  ...
  },
  {
    ...
    subPages: [
      ...
      { label: "Entity rules", href: "/the-boys/entity-rules", primary: false },
