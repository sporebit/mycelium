...
## Corpus Check
- Large corpus: 1008 files · ~1,224,857 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 3638 nodes · 6736 edges · 256 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 3108 · imports: 1712 · imports_from: 1183 · calls: 652 · references: 36 · rationale_for: 32 · method: 13


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1008 · Candidates: 1769
- Excluded: 78 untracked · 53030 ignored · 4 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `a249eb8`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `createServerClient()` - 234 edges
2. `Mono()` - 94 edges
3. `PATCH()` - 38 edges
...
Cohesion: 0.04
Nodes (8): POST(), GET(), POST(), userId(), GET(), TABLES, createServerClient(), POST()

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (27): Ad, PLATFORM_COLOURS, Venture, DIFF_COLOURS, DIFF_LABELS, DIFFICULTIES, EMPTY_MODAL, Guide (+19 more)
...
Cohesion: 0.13
Nodes (16): ALLOWED, ALLOWED_FIELDS, CATEGORIES, Ctx, DELETE(), GET(), loadDetail(), PATCH() (+8 more)
...
Cohesion: 0.08
Nodes (17): DailyData, DailyItem, DailyLog, Slot, Supplements(), Panel(), SectionLabel(), ProgrammesList() (+9 more)
...
Cohesion: 0.13
Nodes (19): DROP_TYPE_COLOURS, calFetch(), createEvent(), credentials(), deleteEvent(), getAccessToken(), GoogleCalendarEvent, listEvents() (+11 more)
...
Cohesion: 0.12
Nodes (14): Habits(), Habit, HABITS, Draft, HabitsConfigModal(), GET(), userId(), cacheKeyForToday() (+6 more)
...
Cohesion: 0.10
Nodes (13): FoodLibrary(), MacroBar(), NutrientDetailPanel(), sum(), formatDate(), NutritionClient(), Tab, Toast (+5 more)
...
Cohesion: 0.12
Nodes (20): FinancePulse(), SnapshotResponse, buildUserMessage(), extractSnapshot(), Breakdown, findClosestBefore(), fmtCurrency(), fmtSigned() (+12 more)
...
Cohesion: 0.13
Nodes (21): FitnessCalendarPage(), parseMonth(), CalendarDay, CalendarPill, CalendarPillState, dowOfDateKey(), fetchMonthCalendar(), fetchSetCounts() (+13 more)
...
Cohesion: 0.19
Nodes (15): refreshFinanceBestEffort(), fetchFinanceSheet(), FinanceNotConfiguredError, SheetData, extractFinance(), getLatestSnapshot(), getSnapshotHistory(), persistSnapshot() (+7 more)
...
Cohesion: 0.23
Nodes (10): SessionKind, TemplateExercise, TemplateSession, CreateBody, POST(), userId(), userOwnsProgramme(), Body (+2 more)

### Community 96 - "Community 96"
Cohesion: 0.15
Nodes (10): ProgrammeSession, Props, SessionSwapDropdown(), SLOT_SHORT, TemplateSlotLike, DAY_SHORT, Slot, Body (+2 more)
...
Cohesion: 0.22
Nodes (9): FitnessCalendarDayPage(), loadProgrammeSessions(), fetchDayCalendar(), backHrefForDate(), CalendarDayView(), fmtFullDate(), Props, TemplateSlot (+1 more)
...
Cohesion: 0.31
Nodes (6): SECTION_BASE_ROUTES, SectionConfig, SECTIONS, SubPage, findSection(), TendrilSpine()
...
Cohesion: 0.33
Nodes (4): Integration, IntegrationsPage(), IntegrationState, loadIntegrations()

### Community 152 - "Community 152"
Cohesion: 0.33
Nodes (5): ABBREV, NavTab, TABS, TopRail(), Wordmark()
...
## Knowledge Gaps
- **786 isolated node(s):** `Decode audio to mono float32 samples via ffmpeg.`, `Logarithmically-spaced frequency band edges from MIN_FREQ to MAX_FREQ.`, `Compute peak magnitude in logarithmically-spaced frequency bands.`, `Extract per-frame audio data.`, `A lint rule: a matcher that yields hits, plus the metadata each hit gets.      A` (+781 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 177`** (2 nodes): `StudioSubNav()`, `TABS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 183`** (2 nodes): `LambdaConfigured()`, `renderViaLambda()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 184`** (2 nodes): `handle`, `WarningsOnly()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 185`** (2 nodes): `CustomHookDriven()`, `useFadeIn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 186`** (2 nodes): `Item`, `MixedBlockers()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 188`** (1 nodes): `Ctx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 189`** (2 nodes): `SECTION_DEFS`, `SectionDef`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 191`** (1 nodes): `EyeRow`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 192`** (1 nodes): `ItemShape`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 193`** (1 nodes): `Ingredient`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 198`** (2 nodes): `RecentlyPlayedResponse`, `SpotifyTrack`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 199`** (2 nodes): `lookupStreaming()`, `StreamingOption`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 207`** (2 nodes): `config`, `si`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 208`** (2 nodes): `GET()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 209`** (1 nodes): `StateDriven()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 210`** (1 nodes): `SideEffectDriven()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 211`** (1 nodes): `MuiDriven()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 212`** (1 nodes): `VOICE_MAP`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 213`** (2 nodes): `GET()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 214`** (2 nodes): `POST()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 215`** (2 nodes): `GET()`, `UID()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 220`** (2 nodes): `GET()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 221`** (1 nodes): `PlayRow`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 223`** (2 nodes): `DELETE()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 224`** (2 nodes): `POST()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 225`** (2 nodes): `DELETE()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 226`** (2 nodes): `POST()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 227`** (1 nodes): `TaskRow`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 233`** (1 nodes): `serwist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 234`** (2 nodes): `format_output()`, `Format results for Claude consumption (token-optimized)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 235`** (1 nodes): `Format`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 236`** (2 nodes): `purchases`, `raw_captures`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 237`** (2 nodes): `workout_exercises`, `workouts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 238`** (2 nodes): `bank_accounts`, `transactions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 239`** (2 nodes): `paypal_payments`, `transactions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 240`** (2 nodes): `auth.users`, `push_subscriptions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 241`** (2 nodes): `supplement_logs`, `supplements`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 242`** (2 nodes): `health_metrics`, `health_workouts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 244`** (2 nodes): `media_items`, `raw_captures`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 245`** (2 nodes): `media_episodes`, `media_items`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 246`** (2 nodes): `nextConfig`, `withSerwist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 247`** (2 nodes): `path`, `svc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 248`** (2 nodes): `path`, `svc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 254`** (1 nodes): `eslintConfig`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 257`** (1 nodes): `pending_workout_routes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 258`** (1 nodes): `workout_session_types`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 259`** (1 nodes): `dashboard_layouts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 260`** (1 nodes): `projects`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 261`** (1 nodes): `routing_rules`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 262`** (1 nodes): `context_options`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 263`** (1 nodes): `pc_components`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 264`** (1 nodes): `places`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 265`** (1 nodes): `reminders`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 266`** (1 nodes): `exercise_aliases`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 268`** (1 nodes): `gut_health_logs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 269`** (1 nodes): `eye_prescriptions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 270`** (1 nodes): `spotify_plays`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 271`** (1 nodes): `pc_metrics`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 272`** (1 nodes): `user_settings`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 273`** (1 nodes): `weather_cache`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 274`** (1 nodes): `config`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `