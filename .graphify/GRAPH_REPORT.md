...
## Corpus Check
- Large corpus: 847 files · ~1,146,450 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2916 nodes · 5652 edges · 196 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 2499 · imports: 1507 · imports_from: 1019 · calls: 555 · rationale_for: 32 · references: 27 · method: 13


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 847 · Candidates: 1562
- Excluded: 0 untracked · 51768 ignored · 1 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `ecd19dc`
- Compare this hash to `git rev-parse HEAD` before trusting freshness-sensitive graph output.
## God Nodes (most connected - your core abstractions)
1. `createServerClient()` - 166 edges
2. `Mono()` - 69 edges
...
Cohesion: 0.07
Nodes (31): ALLOWED, DELETE(), ensureOwned(), PATCH(), userId(), EditableSession, ProgrammeEditor(), SLOT_LABEL (+23 more)
...
Cohesion: 0.08
Nodes (17): Goals, Journal(), MOOD_TONE, Mono(), Panel(), SectionLabel(), ProgrammesList(), Toast (+9 more)
...
Cohesion: 0.09
Nodes (7): GET(), userId(), GET(), POST(), userId(), createServerClient(), TaskRow
...
Cohesion: 0.13
Nodes (16): FinishBody, POST(), userId(), BodyMetricsView(), Toast, UNIT_LABEL, UNITS, isHeavyLift() (+8 more)
...
Cohesion: 0.14
Nodes (6): ContextSwitcherGate(), FAB_ROUTES, FloatingCapture(), Toast, GlobalSearch(), Shell()
...
Cohesion: 0.17
Nodes (6): OverviewCard, SectionOverview(), CARDS, CARDS, CARDS, CARDS
...
Cohesion: 0.19
Nodes (4): Agent, AgentChat(), Message, Toast
...
Cohesion: 0.26
Nodes (10): callClaude(), GET(), getDaBoiContext(), POST(), userId(), AGENT_SYSTEM_PROMPTS, buildDaBoiPrompt(), callClaude() (+2 more)
...
## Knowledge Gaps
- **566 isolated node(s):** `Decode audio to mono float32 samples via ffmpeg.`, `Logarithmically-spaced frequency band edges from MIN_FREQ to MAX_FREQ.`, `Compute peak magnitude in logarithmically-spaced frequency bands.`, `Extract per-frame audio data.`, `A lint rule: a matcher that yields hits, plus the metadata each hit gets.      A` (+561 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 143`** (2 nodes): `FitnessSubNav()`, `TABS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (2 nodes): `LambdaConfigured()`, `renderViaLambda()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (2 nodes): `handle`, `WarningsOnly()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (2 nodes): `CustomHookDriven()`, `useFadeIn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 152`** (2 nodes): `Item`, `MixedBlockers()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 162`** (1 nodes): `StateDriven()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 163`** (1 nodes): `SideEffectDriven()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 164`** (1 nodes): `MuiDriven()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 165`** (2 nodes): `GET()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 166`** (2 nodes): `POST()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 167`** (2 nodes): `GET()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 168`** (2 nodes): `DELETE()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 169`** (2 nodes): `POST()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 170`** (2 nodes): `DELETE()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 171`** (2 nodes): `POST()`, `userId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 172`** (1 nodes): `loadSessionDetail()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 174`** (1 nodes): `serwist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 175`** (2 nodes): `format_output()`, `Format results for Claude consumption (token-optimized)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 176`** (1 nodes): `Format`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 177`** (2 nodes): `purchases`, `raw_captures`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 178`** (2 nodes): `workout_exercises`, `workouts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 179`** (2 nodes): `bank_accounts`, `transactions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 180`** (2 nodes): `paypal_payments`, `transactions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 181`** (2 nodes): `auth.users`, `push_subscriptions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 182`** (2 nodes): `supplement_logs`, `supplements`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 183`** (2 nodes): `health_metrics`, `health_workouts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 185`** (2 nodes): `nextConfig`, `withSerwist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 189`** (1 nodes): `eslintConfig`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 192`** (1 nodes): `pending_workout_routes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 193`** (1 nodes): `workout_session_types`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 194`** (1 nodes): `dashboard_layouts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 195`** (1 nodes): `projects`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 196`** (1 nodes): `routing_rules`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 197`** (1 nodes): `context_options`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 198`** (1 nodes): `pc_components`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 199`** (1 nodes): `places`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 200`** (1 nodes): `reminders`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 201`** (1 nodes): `exercise_aliases`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 203`** (1 nodes): `config`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `createServerClient()` connect `Community 36` to `Community 81`, `Community 3`, `Community 2`, `Community 50`, `Community 109`, `Community 58`, `Community 11`, `Community 22`, `Community 76`, `Community 121`, `Community 52`, `Community 32`, `Community 153`, `Community 127`, `Community 40`, `Community 77`, `Community 59`, `Community 64`, `Community 60`, `Community 96`, `Community 165`, `Community 37`, `Community 6`, `Community 154`, `Community 78`, `Community 8`, `Community 25`, `Community 38`, `Community 84`, `Community 101`, `Community 138`, `Community 139`, `Community 122`, `Community 102`, `Community 68`, `Community 91`, `Community 166`, `Community 41`, `Community 140`, `Community 79`, `Community 128`, `Community 103`, `Community 26`, `Community 114`, `Community 129`, `Community 92`, `Community 53`, `Community 39`, `Community 85`, `Community 93`, `Community 15`, `Community 141`, `Community 167`, `Community 126`, `Community 137`, `Community 54`, `Community 131`, `Community 142`, `Community 132`, `Community 44`, `Community 18`, `Community 65`, `Community 20`, `Community 33`, `Community 168`, `Community 169`, `Community 133`, `Community 170`, `Community 171`, `Community 19`, `Community 10`, `Community 4`, `Community 86`, `Community 172`, `Community 67`, `Community 9`, `Community 29`, `Community 34`, `Community 83`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `Mono()` connect `Community 9` to `Community 75`, `Community 27`, `Community 87`, `Community 88`, `Community 51`, `Community 116`, `Community 44`, `Community 47`, `Community 18`, `Community 63`, `Community 23`, `Community 111`, `Community 28`, `Community 31`, `Community 32`, `Community 99`, `Community 26`, `Community 117`, `Community 22`, `Community 1`, `Community 14`, `Community 43`, `Community 46`, `Community 42`, `Community 41`, `Community 86`, `Community 34`, `Community 8`, `Community 13`, `Community 61`, `Community 6`, `Community 84`, `Community 4`, `Community 15`, `Community 37`, `Community 105`, `Community 106`, `Community 71`, `Community 56`, `Community 89`, `Community 3`, `Community 90`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `localDateKey()` connect `Community 15` to `Community 2`, `Community 109`, `Community 58`, `Community 52`, `Community 25`, `Community 7`, `Community 26`, `Community 92`, `Community 86`, `Community 34`, `Community 35`, `Community 28`, `Community 1`, `Community 41`, `Community 6`, `Community 31`, `Community 98`, `Community 106`, `Community 67`, `Community 38`?**
